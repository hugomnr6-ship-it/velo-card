...
export const allBadgeDefinitions: AchievementBadge[] = [
  ...
  // Social (5)
  { id: "first_duel", name: "Premier Duel", description: "Participe à ton premier duel", icon: "\u2694\uFE0F", category: "social", rarity: "common" },
  { id: "duel_win_5", name: "Duelliste", description: "Gagne 5 duels", icon: "\uD83C\uDFC6", category: "social", rarity: "rare" },
  { id: "first_war", name: "Guerrier", description: "Participe à une guerre", icon: "\uD83D\uDEE1\uFE0F", category: "social", rarity: "common" },
  { id: "club_joined", name: "Membre", description: "Rejoins un club", icon: "\uD83E\uDD1D", category: "social", rarity: "common" },
  { id: "echappee_once", name: "Échappée", description: "Sélectionné dans l'Échappée", icon: "\u2B50", category: "social", rarity: "epic" },
  // Performance (5)
  ...
  { id: "speed_demon", name: "Démon de Vitesse", description: "PAC >= 70", icon: "\uD83D\uDCA8", category: "performance", rarity: "epic" },
  { id: "iron_legs", name: "Jambes d'Acier", description: "RES >= 60", icon: "\uD83E\uDDBF", category: "performance", rarity: "rare" },
  { id: "mountain_goat", name: "Chèvre de Montagne", description: "MON >= 80", icon: "\uD83D\uDC10", category: "performance", rarity: "legendary" },
  // Race badges (8)
  { id: "race_first_win", name: "Première Victoire", description: "Remporte ta première course", icon: "\uD83E\uDD47", category: "race", rarity: "epic" },
  { id: "race_podium_3", name: "Podium Machine", description: "3 podiums au total", icon: "\uD83C\uDFC5", category: "race", rarity: "rare" },
  { id: "race_10_starts", name: "Décathlonien", description: "10 courses disputées", icon: "\uD83C\uDFCE\uFE0F", category: "race", rarity: "rare" },
  ...
  { id: "race_climber", name: "Grimpeur Confirmé", description: "3 top 10 en course montagne", icon: "\u26F0\uFE0F", category: "race", rarity: "epic" },
  // Duel badges (new)
  { id: "duel_win_10", name: "Duelliste Confirmé", description: "Gagne 10 duels", icon: "\u2694\uFE0F", category: "social", rarity: "epic" },
  { id: "duel_win_25", name: "Gladiateur", description: "Gagne 25 duels", icon: "\uD83D\uDDE1\uFE0F", category: "social", rarity: "legendary" },
  { id: "duel_streak_5", name: "Invincible", description: "5 duels gagnés d'affilée", icon: "\uD83D\uDEE1\uFE0F", category: "social", rarity: "epic" },
  // War badges (new)
  { id: "war_veteran_5", name: "Vétéran de Guerre", description: "Participe à 5 guerres", icon: "\uD83C\uDF96\uFE0F", category: "social", rarity: "rare" },
  { id: "war_champion_3", name: "Champion de Guerre", description: "3 guerres gagnées", icon: "\uD83C\uDFF0", category: "social", rarity: "epic" },
  ...
  { id: "first_pack", name: "Déballage", description: "Ouvre ton premier pack", icon: "\uD83D\uDCE6", category: "progression", rarity: "common" },
  { id: "pack_legendary", name: "Coup de Chance", description: "Obtiens un item légendaire dans un pack", icon: "\uD83C\uDF1F", category: "progression", rarity: "legendary" },
  { id: "quest_master_10", name: "Maître des Quêtes", description: "Complète 10 quêtes", icon: "\uD83C\uDFAF", category: "progression", rarity: "rare" },
  { id: "quest_master_50", name: "Légende des Quêtes", description: "Complète 50 quêtes", icon: "\uD83D\uDC8E", category: "progression", rarity: "epic" },
  ...
  // Fantasy badges (4)
  { id: "fantasy_first_league", name: "Manager Débutant", description: "Rejoins ta première ligue Fantasy", icon: "\u26BD", category: "social", rarity: "common" },
  { id: "fantasy_champion", name: "Champion Fantasy", description: "Gagne une ligue Fantasy", icon: "\uD83C\uDFC6", category: "social", rarity: "legendary" },
  { id: "fantasy_draft_master", name: "Œil de Scout", description: "Compose une équipe complète 5/5", icon: "\uD83D\uDC41\uFE0F", category: "social", rarity: "rare" },
  { id: "fantasy_streak", name: "Meilleur Chaque Semaine", description: "Termine 1er 3 semaines d'affilée", icon: "\uD83D\uDD25", category: "social", rarity: "epic" },
];
