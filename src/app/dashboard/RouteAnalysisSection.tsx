                ...
                {climbs.map((climb, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-bold text-white truncate">{climb.name}</p>
                      <p className="text-[10px] text-white/30">
                        {climb.length} km · {climb.elevGain}m D+ · {climb.startEle}m → {climb.endEle}m
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-[10px] font-bold text-white/50">max {climb.maxGradient}%</p>
                      <p className="text-[9px] text-white/20">KM {Math.round(climb.distStart * 10) / 10}</p>
                    </div>
                  </div>
                ))}
              </div>
