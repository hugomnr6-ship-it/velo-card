...
import { IconStar, STAT_ICONS } from "@/components/icons/VeloIcons";
  ...
  if (!data || data.team.length === 0) {
    return (
      <AnimatedPage className="flex min-h-screen flex-col items-center gap-6 px-4 pb-24 pt-12">
        <PageHeader
          icon={<IconStar size={24} className="text-[#FFD700]/60" />}
          title="Team of the Week"
        />
        <p className="text-sm text-white/40">
          Pas encore de TOTW cette semaine. Reviens lundi !
        </p>
      </AnimatedPage>
    );
  }
  ...
  return (
    <AnimatedPage className="flex min-h-screen flex-col items-center gap-6 px-4 pb-24 pt-12">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        >
          <IconStar size={28} className="text-[#FFD700]/60" />
