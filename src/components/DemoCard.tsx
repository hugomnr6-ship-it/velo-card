...
const tierVisuals: Record<CardTier, TierVisual> = {
  ...
  argent: {
    accent: "#C0C8D4",
    bg: "linear-gradient(170deg, #12141A, #1C1F28 50%, #12141A)",
    crestGrad: "linear-gradient(180deg, #D4D8E0, #A0A8B4)",
    crestText: "#12141A",
    ringGrad: "linear-gradient(180deg, #D4D8E0, #8890A0)",
    statColor: "#D8DCE4",
    glow: "rgba(192,200,212,0.25)",
    border: "rgba(192,200,212,0.2)",
    divider: "rgba(192,200,212,0.2)",
    gaugeBg: "rgba(192,200,212,0.06)",
    shimmer: "rgba(192,200,212,0.14)",
    label: "ARGENT",
  },
  platine: {
    accent: "#E0E8F0",
